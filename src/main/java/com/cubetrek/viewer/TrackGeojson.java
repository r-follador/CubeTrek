...
@JsonSerialize(using = TrackGeojson.TrackLightGeojsonSerializer.class)
public class TrackGeojson implements Serializable{
    ...
    @Transactional
    protected static class TrackLightGeojsonSerializer extends JsonSerializer<TrackGeojson> {
        @Override
